...
At the moment, all the coordinates of all the places mentioned on a speech have the same weight when computing the center. However, the code allows for this weights to be set in a different manner if needed.
